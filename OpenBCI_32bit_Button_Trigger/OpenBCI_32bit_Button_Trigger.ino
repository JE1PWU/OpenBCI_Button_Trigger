 ...
 *
 * This code uses the on-board pushbutton switch as a trigger input
 * Tutorial can be found here: http://docs.openbci.com/tutorials/05-External_Trigger_32bit_Example
 *
...
void setup(void) {
  ...
  pinMode(LED, OUTPUT); digitalWrite(LED,state);    // blue LED
